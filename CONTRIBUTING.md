...
For all other issues and pull requests, the https://github.com/mraksoll4/bitweb node repository should be used.
...
[Translation Process](https://github.com/mraksoll4/bitweb/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/mraksoll4/bitweb  # Fetch the latest upstream commit
...
https://github.com/mraksoll4/bitcoin-maintainer-tools#backport).
